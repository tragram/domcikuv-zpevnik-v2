...
def generate_missing_prompts(prompt_model, prompt_id):
    ...
    for i,song in enumerate(songs):
        existing_prompt = retrieve_model_prompt(
            prompt_path(song.stem), prompt_model, None if GENERATE_ONLY_MISSING else prompt_id
        )
...
generate_missing_prompts(prompt_id=SELECTED_PROMPT, prompt_model=SELECTED_PROMPT_MODEL)
