...
Humans are lazy, so why would you repeat yourself unnecessarily? Adding chords to repeated verses (or chords, provided the lyrics change) is boring. But it's useful on the website when the whole song does not fit on the screen. You do not have to do this yourself though - it's the age of AI after all!
