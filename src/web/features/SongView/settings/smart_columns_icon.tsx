const SmartColumnsIcon = () => {
    return (
        <svg width="24" height="24" version="1.1" viewBox="0 0 6.35 6.35" xmlns="http://www.w3.org/2000/svg">
            <g transform="translate(-102.39 -133.09)" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
                <g transform="matrix(.29104 0 0 .29104 102.08 132.77)" strokeWidth="2">
                    <rect x="3" y="3" width="18" height="18" rx="2" />
                    <path d="m12 3v18" strokeWidth="1.5118" />
                </g>
                <g transform="matrix(.17359 0 0 .17359 103.49 134.18)" strokeWidth="2.575">
