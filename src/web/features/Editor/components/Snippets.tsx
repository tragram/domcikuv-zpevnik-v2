...
export const SnippetButtonSection: React.FC<{
  label: string;
  className?: string;
  ...
  return (
    <div
      className={cn(
        "flex flex-col grow justify-center border-primary bg-primary p-2",
        className,
      )}
    >
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <button
            ...
            className={cn(
              "text-base font-semibold py-1 px-2 text-white rounded-md hover:bg-background grow max-w-16",
              className,
            )}
          >
            {snippet.letter}
