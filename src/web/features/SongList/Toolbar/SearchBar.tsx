        ...
        <>
                ...
                >
                    ...
                    >
                        ...
                        <Input
                            ...
                            value={query}
                            placeholder="Search..."
                            className={cn("pl-3 pr-7 text-sm font-medium placeholder:font-normal border-none rounded-full rounded-l-none peer text-primary placeholder:text-primary dark:placeholder:text-primary/30",
                                query ? "" : "")}
                        />
                        <ClearButton />
                    </div>
            ...
            < div className={cn("relative hidden min-[400px]:flex items-center h-full text-primary dark:text-primary/30 transition-all duration-300 ease-in-out shadow-md rounded-full flex-1 outline-primary dark:outline-primary/30 outline-2")}>
                <Input
                    ...
                    value={query}
                    placeholder="Search..."
                    className={cn("pl-10 pr-7 text-sm h-full font-medium placeholder:font-normal border-none rounded-full peer dark:bg-background focus:bg-background text-primary placeholder:text-primary dark:placeholder:text-primary/30",
                        query ? "bg-background dark:bg-primary/30 focus:dark:bg-primary/30" : "bg-white dark:bg-background")}
                />
                <ClearButton />
