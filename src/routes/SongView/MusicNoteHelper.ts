// IDK if JS/TS are incredibly stupid or I am but I was not able to import this from the library, so this is copied from https://github.com/chordproject/chorpro-parser/blob/master/src/utilities/MusicNoteHelper.ts

import { MusicAccidental, MusicLetter, MusicNote } from "chordproject-parser";

export class MusicNoteHelper {
    ...
    public static letterDiff(firstLetter: MusicLetter, secondLetter: MusicLetter): number {
        ...
        const diff = secondLetterIndex - firstLetterIndex;
