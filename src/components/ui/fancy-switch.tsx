...
export default function FancySwitch({ options, selectedOption, setSelectedOption, roundedClass, children, vertical = false, full = false, hiddenHighlightOnOther = false }) {
